...
const PANELS: PanelDefinition[] = [
  ...
  },
  {
    ...
    probes: [
      ...
      { method: 'GET', path: '/api/bridge/errors' },
      { method: 'GET', path: '/api/bridge/metrics/queue-forecast', query: 'window=120' },
      { method: 'GET', path: '/api/bridge/metrics/prompt-performance' },
      { method: 'GET', path: '/api/bridge/metrics/prompt-performance/timeline' },
      { method: 'GET', path: '/api/bridge/events' },
      { method: 'GET', path: '/api/claude-code/stats-v2' },
      { method: 'GET', path: '/api/bridge/metrics/throughput' },
      { method: 'GET', path: '/api/bridge/metrics/limiters' },
      { method: 'GET', path: '/api/bridge/metrics/usage-breakdown' },
      { method: 'GET', path: '/api/bridge/metrics/persistent' },
      { method: 'GET', path: '/api/bridge/metrics/activity' },
    ],
    mutations: [
      'POST /api/claude-code/scrape-now',
      'USE /api/bridge-proxy',
    ],
    notes: '/api/bridge-proxy is a raw proxy pass-through to Bridge service (Hetzner) — not probed as it requires Bridge-internal routing',
  },
  {
    name: 'qa-dashboard',
  ...
  },
  {
    ...
    probes: [
      ...
      { method: 'GET', path: '/api/admin/wr/feedback' },
      { method: 'GET', path: '/api/admin/wr/impersonation' },
      { method: 'GET', path: '/api/admin/wr/infrastructure' },
      { method: 'GET', path: '/api/admin/wr/stats' },
      { method: 'GET', path: '/api/admin/wr/usage/activity' },
      { method: 'GET', path: '/api/admin/wr/usage/activity/users', query: 'tenantId=...' },
      { method: 'GET', path: '/api/admin/wr/usage/trend' },
    ...
    mutations: [
      ...
      'POST /api/admin/wr/env',
      'POST /api/admin/wr/config',
  ...
  },
  {
    ...
    mutations: ['POST /api/control'],
    notes: 'POST /api/control sends file-preview control message on node click (best-effort)',
  },
  {
    name: 'calendar',
  ...
  },
  {
    ...
    probes: [
      ...
      { method: 'GET', path: '/api/prompt-explorer/scan' },
    ],
    mutations: [
      'GET /api/disk-tree',
      'GET /api/file',
    ],
    notes: 'Scan via GET /scan/:id — kein Schreib-Zugriff by design. /api/disk-tree und /api/file sind geteilte Utility-Endpoints (files.ts), hier als KI-Sicht deklariert.',
  },
  {
    name: 'business-angel',
    ...
    mutations: [
      ...
      'POST /api/business-angel/load',
      'POST /api/business-angel/session/load/:id',
      'POST /api/business-angel/snapshot',
      'GET /api/business-angel/file-preview',
      'GET /api/business-angel/snapshot',
    ],
    notes: 'GET /api/business-angel/file-preview (requires ?path=) und GET /api/business-angel/snapshot (requires ?session_id=) sind param-required — via OPTIONS-Probe als wired verifiziert',
  },
  {
    name: 'activity-feed',
    ...
    coverage: 'read-only',
    probes: [
      { method: 'GET', path: '/api/partner/activity', query: 'app=werking-energy&limit=50' },
    ],
  },
  {
  ...
  {
    name: 'report-builder',
    component: 'components/panels/ReportBuilder/ReportBuilder.tsx',
    coverage: 'full',
    probes: [
    ...
    mutations: [
      ...
      'PUT /api/report-builder/sessions/:id',
      'DELETE /api/report-builder/sessions/:id',
  ...
  },
  {
    ...
    probes: [
      ...
      { method: 'GET', path: '/api/audit/summary', query: 'hours=24' },
    ],
    notes: 'Inherent read-only — audit trail viewer for user inputs across sessions',
  },
];
