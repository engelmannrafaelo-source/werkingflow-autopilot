...
exports.migrateFreshnessIndex = migrateFreshnessIndex;
...
async function migrateFreshnessIndex() {
    ...
    try {
        ...
        const freshnessContent = await fs_1.promises.readFile(FRESHNESS_INDEX_PATH, 'utf-8');
        ...
        for (const [docPath, freshnessDoc] of Object.entries(freshnessIndex.documents)) {
            ...
            const absolutePath = (0, path_1.join)(BUSINESS_PATH, normalizedPath);
        ...
        await fs_1.promises.writeFile(KNOWLEDGE_REGISTRY_PATH, JSON.stringify(registry, null, 2), 'utf-8');
        console.log(`[Migration] ✓ Saved KNOWLEDGE_REGISTRY.json`);
        // 7. Backup FRESHNESS_INDEX.json
        await fs_1.promises.copyFile(FRESHNESS_INDEX_PATH, FRESHNESS_INDEX_PATH.replace('.json', '.backup.json'));
